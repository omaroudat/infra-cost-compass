    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div className="flex items-center gap-4">
          <h2 className="text-xl font-bold">Break-Down Items / وصف البنود الفرعية (Leaf Items with Quantities)</h2>
        ...
        <div className="text-sm text-gray-600">
          <p>Breakdown items are automatically created from leaf BOQ items with quantities {'>'}  0</p>
